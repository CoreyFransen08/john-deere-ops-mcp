...
**Endpoint ID:** `#/organizations/{orgId}/farms/{farmId}/get`
...
Get farm by organization and farmId

**Request URI**

```
GET https://sandboxapi.deere.com/platform/organizations/{orgId}/farms/{farmId}
```
