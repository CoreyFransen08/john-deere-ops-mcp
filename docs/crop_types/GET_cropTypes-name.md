...
**Endpoint ID:** `#/cropTypes/{name}/get`
...
```
GET https://sandboxapi.deere.com/platform/cropTypes/{name}
```
...
| --- | --- | --- | --- |
| name<br>Required | string | This is the crop type name<br>Example: ENERGY_CANE | path |
...
| name | string | This is the crop type name.<br>Example: ENERGY_CANE |
