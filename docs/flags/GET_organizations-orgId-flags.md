...
**Endpoint ID:** `#/organizations/{orgId}/flags/get`
...
This resource will return a Flags list for Organization.
...
```
GET https://sandboxapi.deere.com/platform/organizations/{orgId}/flags
```
...
```
{
  "links": [
    {
      "rel": "self",
      "uri": "https://sandboxapi.deere.com/platform/organizations/1234/flags"
    }
  ],
  "total": 1,
  "values": [
