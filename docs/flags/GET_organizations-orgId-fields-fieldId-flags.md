...
**Endpoint ID:** `#/organizations/{orgId}/fields/{fieldId}/flags/get`
...
This resource will return a list of flag objects associated with the field.
...
```
GET https://sandboxapi.deere.com/platform/organizations/{orgId}/fields/{fieldId}/flags
```
...
| fieldId<br>Required | GUID | Fields guid of the field.<br>Example: c634597d-3d1a-4975-93e9-acc6696658d2 | N/A | path |
...
```
{
  "links": [
    {
      "rel": "self",
      "uri": "https://sandboxapi.deere.com/platform/organizations/123456/fields/c634597d-3d1a-4975-93e9-acc6696658d2/flags"
    }
  ],
  "total": 1,
  "values": [
    {
      ...
      "links": [
        ...
        },
        {
          ...
          "uri": "https://sandboxapi.deere.com/platform/flagCategories/47a229fc-aa09-4618-956c-1c29ae884326"
        },
        {
          "rel": "createdBy",
