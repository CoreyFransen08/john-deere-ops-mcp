...
**Endpoint ID:** `#/organizations/{orgId}/fields/{fieldId}/get`
...
```
GET https://sandboxapi.deere.com/platform/organizations/{orgId}/fields/{fieldId}
```
...
```
{
  ...
  "links": [
    ...
    },
    {
      "@type": "Link",
      "rel": "farms",
      "uri": "https://sandboxapi.deere.com/platform/organizations/123456/fields/d61b83f4-3a12-431e-8010-596f2466dc2/farms"
    },
    {
      "@type": "Link",
